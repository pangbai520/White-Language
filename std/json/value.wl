...
class Object {
    ...
    method set(key -> String, value -> Value) -> Void? {
    ...
    method key_at(index -> Int) -> String? {
    ...
    method value_at(index -> Int) -> Value? {
...
class Value {
    ...
    method append(value -> Value) -> Void? {
        if (self.__kind != Kind.Array) { throw JsonError.TypeMismatch; }
